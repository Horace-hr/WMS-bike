...
<script>
	...
	function orderForecast(){
		$('#order_forecast').click(function() {
			$('#forecast_modal').modal("show");
		})
		$('#start_forecast').click(function() {
			var customerId=$("#customerId option:selected").val();
			$.ajax({
				type : "GET",
				url : "customerManage/getCustomerId",
				dataType : "json",
				contentType : "application/json",
				...
				success : function(response) {
					...
					if (response.result == "success") {
						type = "success";
						msg = "推荐成功，根据相似指数："+response.data[0].value+",可推荐  "+response.data[0].itemID+" 编号自行车!";
	...
	<div class="panel-body">
		...
		<div class="row" style="margin-top: 25px">
			<div class="col-md-5">
				...
				<button class="btn btn-sm btn-default" id="order_forecast">
					<span class="glyphicon glyphicon-question-sign"></span> <span>客户订购预测</span>
				</button>
...
<!-- 添加客户订购预测模态框 -->
<div id="forecast_modal" class="modal fade" table-index="-1" role="dialog"
	aria-labelledby="myModalLabel" aria-hidden="true"
	data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" type="button" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel">客户订购预测</h4>
			</div>
			<div class="modal-body">
				<!-- 模态框的内容 -->
				<div class="row">
					...
					<div class="col-md-8 col-sm-8">
						<form class="form-horizontal" role="form"
							style="margin-top: 25px">
							<div class="form-group">
								<label for="" class="control-label col-md-4 col-sm-4"> <span>选择预测客户：</span>
								</label>
								<div class="row">
								      <div class="col-md-6">
                                            <select id="customerId" class="btn btn-default dropdown-toggle"  data-style="btn-default btn-block" data-menu-style="dropdown-blue">
                                                <option value="1214">天津市武清区君飞自行车商店 </option>
                                                <option value="1215">义乌市一泉自行车有限公司</option>
                                                <option value="1216">汕头市金平区川野自行车有限公司</option>
                                                <option value="1217">江苏拓途自行车有限公司</option>
                                            </select>
                                        </div>
								 </div>
							</div>
			...
			<div class="modal-footer">
				...
				<button class="btn btn-success" type="button" id="start_forecast">
					<span>开始预测</span>
				</button>
			</div>
		</div>
